...
<section id="main" class="column">
    ...
    <article class="module width_full">
        <form autocomplete="off" action="<?php echo base_url() ?>index.php/adm_ent_repo/insert_repo/" method="post" onsubmit="return verificampos();" enctype="multipart/form-data">
            ...
            <div class="module_content">
                ...
                <fieldset id="formulario" style="display: none;">
                    ...
                    <input type="text" name="host" id="host" onkeypress="return justNumbers(event);" /><br>
                    <label id="lmetadata">Estandar de Metadatos</label>
                    <input type="text" name="metadata" id="metadata" />
                    <label id="lpuerto">Puerto</label><br>
                    <input type="text" name="puerto" id="puerto" onkeypress="return justNumbers(event);" /><br>
                    ...
                    <input type="text" id="periodicidad"  name="periodicidad" onkeypress="return justNumbers(event);"><br>
