            ...
            <tr class="gradeA">
                <td>
                    <div class="info">
                        <table>
                            <tr>
                                <td width="200"><b>Titulo:</b></td><td><a href="<?php echo base_url() ?>oas/ver_objeto/?url=<?php echo $row['location'] ?>" title="Ver este Objeto" style="text-decoration: none; " target="blank"><?php if (!empty($row['general_title'])) echo $row['general_title']; ?></a></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (!empty($keyword)) {
                                        foreach ($keyword as $key) {
                                            if ($key['idlom'] == $row['idlom'] && $key['idrepository'] == $row['idrepository']) {
                                                echo $key['keyword'] . ', ';
                                            }
                                        }
                                    }
