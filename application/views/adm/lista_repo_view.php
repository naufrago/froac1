                        ...
                        foreach ($repos as $key) {
                            ...
                            <tr>
                                ...
                                <td width="55%">
                                    <table>
                                        <tr>
                                        <form autocomplete="off" action="<?php echo base_url() ?>repositorio/lista/" method="post" enctype="multipart/form-data">
                                            <input type="hidden" id="idrepository<?php echo $i ?>" name="idrepository" value="<?php echo $key['idrepository']; ?>" />
